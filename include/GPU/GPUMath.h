...
__device__ static void _ShiftR62(uint64_t* r);
__device__ static void _ShiftR62(uint64_t* r, uint64_t* u, uint64_t carry);
__device__ static void _IMult(uint64_t* r, uint64_t* a, int64_t b);
__device__ static uint64_t _IMultC(uint64_t* r, uint64_t* a, int64_t b);
__device__ static void _MulP(uint64_t* r, uint64_t a);
__device__ static void _ModNeg256(uint64_t* r, uint64_t* a);
__device__ static void _ModNeg256(uint64_t* r);
__device__ static void _ModAdd256(uint64_t* r, uint64_t* a, uint64_t* b);
__device__ static void _ModSub256(uint64_t* r, uint64_t* a, uint64_t* b);
__device__ static void _ModSub256(uint64_t* r, uint64_t* b);
__device__ static void _DivStep62(uint64_t* u, uint64_t* v, int32_t* pos, int64_t* uu, int64_t* uv, int64_t* vu, int64_t* vv);
__device__ static void _MatrixVecMulHalf(uint64_t* dest, uint64_t* u, uint64_t* v, int64_t _11, int64_t _12, uint64_t* carry);
__device__ static void _MatrixVecMul(uint64_t* u, uint64_t* v, int64_t _11, int64_t _12, int64_t _21, int64_t _22);
__device__ static uint64_t _AddCh(uint64_t* r, uint64_t* a, uint64_t carry);
__device__ static void _ModInv(uint64_t* R);
__device__ static void _ModMult(uint64_t* r, uint64_t* a, uint64_t* b);
__device__ static void _ModMult(uint64_t* r, uint64_t* a);
__device__ static void _ModSqr(uint64_t* rp, const uint64_t* up);
__device__ static int _BinarySearch(uint64_t* buffer, int hi, uint64_t target);
__device__ static void _PointAddSecp256k1(uint64_t* p1x, uint64_t* p1y, uint64_t* p1z, uint64_t* p2x, uint64_t* p2y);
...
__device__ static void _ShiftR62(uint64_t dest[5], uint64_t r[5], uint64_t carry)
{
...
__device__ static __forceinline__ uint32_t _CTZ(uint64_t x)
{
    uint32_t n;
    asm("{\n\t"
        " .reg .u64 tmp;\n\t"
...
__device__ static void _DivStep62(uint64_t u[5], uint64_t v[5],
                           int32_t *pos,
...
__device__ static void _MatrixVecMulHalf(uint64_t dest[5], uint64_t u[5], uint64_t v[5], int64_t _11, int64_t _12, uint64_t *carry)
{
...
__device__ static void _MatrixVecMul(uint64_t u[5], uint64_t v[5], int64_t _11, int64_t _12, int64_t _21, int64_t _22)
{
...
__device__ static uint64_t _AddCh(uint64_t r[5], uint64_t a[5], uint64_t carry)
{
...
__device__ static __noinline__ void _ModInv(uint64_t *R)
{
...
__device__ static void _ModSqr(uint64_t *rp, const uint64_t *up)
{
    ...
    // Reduce from 320 to 256
    UADD1(r4, 0ULL);
    UMULLO(al, r4, 0x1000003D1ULL);
    UMULHI(ah, r4, 0x1000003D1ULL);
    UADDO(rp[0], r512[0], al);
    UADDC(rp[1], r512[1], ah);
