...
Point Secp256K1::AddPoint2(Point &p1, Point &p2) {
  ...
  v1.ModMulK1(&p1.y, &p2.z);
  v2.ModMulK1(&p2.y, &p1.z);
  u = u1;
  u.ModSub(&u2);
  v = v1;
  v.ModSub(&v2);
  ...
  x3.ModMulK1(&v, &vs2);
  vs3y1.ModMulK1(&vs3, &p1.y);
  a.ModSub(&us2w, &_2vs2v2);
  a.ModMulK1(&a, &p1.z);

  Point r;
  r.x.ModMulK1(&x3, &p2.z);
  r.y.ModAdd(&vs3y1, &vs3y1);
  r.z.Set(&a);
